...
const LAWS = [
  ...
  { id:51, title_bg:"Закон за кадастъра и имотния регистър", title_ru:"Закон о кадастре и имотном реестре", title_en:"Cadastre and Property Register Act", type:"zakon", area:["property"], year:2000, url:"https://lex.bg/laws/ldoc/2134447436" },
  { id:52, title_bg:"Закон за нотариусите и нотариалната дейност (ЗННД)", title_ru:"Закон о нотариусах и нотариальной деятельности", title_en:"Notaries and Notarial Activity Act", type:"zakon", area:["property","civil"], year:1996, url:"https://lex.bg/laws/ldoc/2134395669" },
  { id:53, title_bg:"Закон за устройство на територията (ЗУТ)", title_ru:"Закон о территориальном устройстве", title_en:"Spatial Planning Act", type:"zakon", area:["property"], year:2001, url:"https://lex.bg/laws/ldoc/2134815623" },
  ...
  { id:55, title_bg:"Закон за наследството", title_ru:"Закон о наследовании", title_en:"Inheritance Act", type:"zakon", area:["property","civil"], year:1949, url:"https://lex.bg/laws/ldoc/1588654725" },
  ...
  { id:82, title_bg:"Закон за задълженията и договорите — допълнения", title_ru:"ЗЗД — поправки", title_en:"OCA — amendments", type:"zakon", area:["civil"], year:1950, url:"https://lex.bg/laws/ldoc/1588654657" },
  { id:83, title_bg:"Закон за лицата и семейството", title_ru:"Закон о лицах и семье", title_en:"Persons and Family Act", type:"zakon", area:["civil"], year:1949, url:"https://lex.bg/laws/ldoc/1588654725" },
