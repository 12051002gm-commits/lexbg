...
const LAWS = [
  // ─── КОДЕКСИ ───────────────────────────────────────────────────────────────
  { id:1, title_bg:"Граждански процесуален кодекс", title_ru:"Гражданский процессуальный кодекс", title_en:"Civil Procedure Code", type:"kodeks", area:["civil"], year:2007, url:"https://lex.bg/bg/laws/ldoc/search?q=Граждански+процесуален+кодекс" },
  { id:2, title_bg:"Наказателен кодекс", title_ru:"Уголовный кодекс", title_en:"Penal Code", type:"kodeks", area:["criminal"], year:1968, url:"https://lex.bg/bg/laws/ldoc/search?q=Наказателен+кодекс" },
  { id:3, title_bg:"Търговски закон", title_ru:"Торговый закон", title_en:"Commercial Act", type:"kodeks", area:["business"], year:1991, url:"https://lex.bg/bg/laws/ldoc/search?q=Търговски+закон" },
  { id:4, title_bg:"Кодекс на труда", title_ru:"Трудовой кодекс", title_en:"Labour Code", type:"kodeks", area:["labor"], year:1986, url:"https://lex.bg/bg/laws/ldoc/search?q=Кодекс+на+труда" },
  { id:5, title_bg:"Данъчно-осигурителен процесуален кодекс", title_ru:"Налогово-страховой процессуальный кодекс", title_en:"Tax-Insurance Procedure Code", type:"kodeks", area:["tax"], year:2005, url:"https://lex.bg/bg/laws/ldoc/search?q=ДОПК" },
  { id:6, title_bg:"Административнопроцесуален кодекс", title_ru:"Административно-процессуальный кодекс", title_en:"Administrative Procedure Code", type:"kodeks", area:["admin"], year:2006, url:"https://lex.bg/bg/laws/ldoc/search?q=Административнопроцесуален+кодекс" },
  { id:7, title_bg:"Семеен кодекс", title_ru:"Семейный кодекс", title_en:"Family Code", type:"kodeks", area:["civil"], year:2009, url:"https://lex.bg/bg/laws/ldoc/search?q=Семеен+кодекс" },
  { id:8, title_bg:"Наказателно-процесуален кодекс", title_ru:"Уголовно-процессуальный кодекс", title_en:"Criminal Procedure Code", type:"kodeks", area:["criminal"], year:2005, url:"https://lex.bg/bg/laws/ldoc/search?q=Наказателно-процесуален+кодекс" },
  { id:9, title_bg:"Закон за задълженията и договорите", title_ru:"Закон об обязательствах и договорах", title_en:"Obligations and Contracts Act", type:"kodeks", area:["civil"], year:1950, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+задълженията+и+договорите" },
  { id:10, title_bg:"Кодекс за социално осигуряване", title_ru:"Кодекс социального страхования", title_en:"Social Insurance Code", type:"kodeks", area:["labor","tax"], year:1999, url:"https://lex.bg/bg/laws/ldoc/search?q=КСО" },
  { id:11, title_bg:"Кодекс за застраховането", title_ru:"Кодекс страхования", title_en:"Insurance Code", type:"kodeks", area:["business","civil"], year:2015, url:"https://lex.bg/bg/laws/ldoc/search?q=Кодекс+за+застраховането" },
  { id:12, title_bg:"Кодекс на международното частно право", title_ru:"Кодекс международного частного права", title_en:"Private International Law Code", type:"kodeks", area:["civil"], year:2005, url:"https://lex.bg/bg/laws/ldoc/search?q=Кодекс+международното+частно+право" },
  // ─── МИГРАЦИЯ ──────────────────────────────────────────────────────────────
  { id:20, title_bg:"Закон за чужденците в Република България", title_ru:"Закон об иностранцах в РБ", title_en:"Foreigners in Bulgaria Act", type:"zakon", area:["migration"], year:1998, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+чужденците+в+Република+България" },
  { id:21, title_bg:"Закон за влизането, пребиваването и напускането на РБ на гражданите на ЕС", title_ru:"Закон о въезде граждан ЕС", title_en:"EU Citizens Entry and Residence Act", type:"zakon", area:["migration"], year:2006, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+влизането+пребиваването+напускането+ЕС" },
  { id:22, title_bg:"Закон за убежището и бежанците", title_ru:"Закон об убежище и беженцах", title_en:"Asylum and Refugees Act", type:"zakon", area:["migration"], year:2002, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+убежището+и+бежанците" },
  { id:23, title_bg:"Закон за българското гражданство", title_ru:"Закон о болгарском гражданстве", title_en:"Bulgarian Citizenship Act", type:"zakon", area:["migration"], year:1998, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+българското+гражданство" },
  { id:24, title_bg:"Закон за трудовата миграция и трудовата мобилност", title_ru:"Закон о трудовой миграции", title_en:"Labour Migration and Mobility Act", type:"zakon", area:["migration","labor"], year:2016, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+трудовата+миграция+и+трудовата+мобилност" },
  { id:25, title_bg:"Закон за насърчаване на инвестициите", title_ru:"Закон о поощрении инвестиций", title_en:"Investment Promotion Act", type:"zakon", area:["business","migration"], year:1997, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+насърчаване+на+инвестициите" },
  { id:26, title_bg:"Закон за гражданската регистрация", title_ru:"Закон о гражданской регистрации", title_en:"Civil Registration Act", type:"zakon", area:["migration","admin"], year:1999, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+гражданската+регистрация" },
  { id:27, title_bg:"Закон за българските лични документи", title_ru:"Закон о болгарских личных документах", title_en:"Bulgarian Identity Documents Act", type:"zakon", area:["migration","admin"], year:1998, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+българските+лични+документи" },
  { id:28, title_bg:"Правилник за прилагане на Закона за чужденците", title_ru:"Правилник по применению Закона об иностранцах", title_en:"Regulation on Application of Foreigners Act", type:"naredba", area:["migration"], year:2011, url:"https://lex.bg/bg/laws/ldoc/search?q=Правилник+за+прилагане+на+Закона+за+чужденците" },
  // ─── ДАНЪЦИ ────────────────────────────────────────────────────────────────
  { id:30, title_bg:"Закон за корпоративното подоходно облагане", title_ru:"Закон о корпоративном налоге", title_en:"Corporate Income Tax Act", type:"zakon", area:["tax"], year:2006, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+корпоративното+подоходно+облагане" },
  { id:31, title_bg:"Закон за данък върху добавената стойност", title_ru:"Закон об НДС", title_en:"VAT Act", type:"zakon", area:["tax"], year:2006, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+данък+върху+добавената+стойност" },
  { id:32, title_bg:"Закон за данъците върху доходите на физическите лица", title_ru:"Закон о НДФЛ", title_en:"Personal Income Tax Act", type:"zakon", area:["tax"], year:2006, url:"https://lex.bg/bg/laws/ldoc/search?q=ЗДДФЛ" },
  { id:33, title_bg:"Закон за местните данъци и такси", title_ru:"Закон о местных налогах и сборах", title_en:"Local Taxes and Fees Act", type:"zakon", area:["tax","property"], year:1997, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+местните+данъци+и+такси" },
  { id:34, title_bg:"Закон за счетоводството", title_ru:"Закон о бухгалтерском учёте", title_en:"Accountancy Act", type:"zakon", area:["tax","business"], year:2015, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+счетоводството" },
  { id:35, title_bg:"Закон за данъка върху добавената стойност — Правилник", title_ru:"Правилник по НДС", title_en:"VAT Implementing Regulation", type:"naredba", area:["tax"], year:2006, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+данъка+върху+добавената+стойност+—+Правилник" },
  // ─── БИЗНЕС ────────────────────────────────────────────────────────────────
  { id:40, title_bg:"Закон за търговския регистър и регистъра на ЮЛНЦ", title_ru:"Закон о торговом реестре", title_en:"Commercial Register Act", type:"zakon", area:["business"], year:2006, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+търговския+регистър+и+регистъра+на+ЮЛНЦ" },
  { id:41, title_bg:"Закон за регистър БУЛСТАТ", title_ru:"Закон о реестре БУЛСТАТ", title_en:"BULSTAT Register Act", type:"zakon", area:["business","migration"], year:2000, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+регистър+БУЛСТАТ" },
  { id:42, title_bg:"Закон за мерките срещу изпирането на пари (ЗМИП)", title_ru:"Закон о мерах против отмывания денег", title_en:"Anti-Money Laundering Act", type:"zakon", area:["business","tax"], year:2018, url:"https://lex.bg/bg/laws/ldoc/search?q=ЗМИП" },
  { id:43, title_bg:"Закон за защита на конкуренцията", title_ru:"Закон о защите конкуренции", title_en:"Competition Protection Act", type:"zakon", area:["business"], year:2008, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+защита+на+конкуренцията" },
  { id:44, title_bg:"Закон за концесиите", title_ru:"Закон о концессиях", title_en:"Concessions Act", type:"zakon", area:["business"], year:2018, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+концесиите" },
  // ─── НЕДВИЖИМОСТ ───────────────────────────────────────────────────────────
  { id:50, title_bg:"Закон за собствеността", title_ru:"Закон о собственности", title_en:"Property Act", type:"zakon", area:["property"], year:1951, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+собствеността" },
  { id:51, title_bg:"Закон за кадастъра и имотния регистър", title_ru:"Закон о кадастре и имотном реестре", title_en:"Cadastre and Property Register Act", type:"zakon", area:["property"], year:2000, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+кадастъра+и+имотния+регистър" },
  { id:52, title_bg:"Закон за нотариусите и нотариалната дейност (ЗННД)", title_ru:"Закон о нотариусах и нотариальной деятельности", title_en:"Notaries and Notarial Activity Act", type:"zakon", area:["property","civil"], year:1996, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+нотариусите+и+нотариалната+дейност+(ЗННД)" },
  { id:53, title_bg:"Закон за устройство на територията (ЗУТ)", title_ru:"Закон о территориальном устройстве", title_en:"Spatial Planning Act", type:"zakon", area:["property"], year:2001, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+устройство+на+територията+(ЗУТ)" },
  { id:54, title_bg:"Закон за управление на етажната собственост", title_ru:"Закон об управлении этажной собственностью", title_en:"Condominium Management Act", type:"zakon", area:["property","civil"], year:2009, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+управление+на+етажната+собственост" },
  { id:55, title_bg:"Закон за наследството", title_ru:"Закон о наследовании", title_en:"Inheritance Act", type:"zakon", area:["property","civil"], year:1949, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+наследството" },
  { id:56, title_bg:"Закон за задълженията към държавата при прехвърляне на недвижим имот", title_ru:"ДОПК чл. 264 — налоги при сделках с имуществом", title_en:"TIPA Art. 264 — tax clearance for property", type:"zakon", area:["property","tax"], year:2005, url:"https://lex.bg/bg/laws/ldoc/search?q=ДОПК" },
  // ─── АДМИНИСТРАТИВНО ───────────────────────────────────────────────────────
  { id:60, title_bg:"Закон за администрацията", title_ru:"Закон об администрации", title_en:"Administration Act", type:"zakon", area:["admin"], year:1998, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+администрацията" },
  { id:61, title_bg:"Закон за достъп до обществена информация", title_ru:"Закон о доступе к информации", title_en:"Access to Public Information Act", type:"zakon", area:["admin"], year:2000, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+достъп+до+обществена+информация" },
  { id:62, title_bg:"Закон за електронното управление", title_ru:"Закон об электронном управлении", title_en:"Electronic Governance Act", type:"zakon", area:["admin"], year:2007, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+електронното+управление" },
  { id:63, title_bg:"Закон за административните нарушения и наказания", title_ru:"Закон об административных нарушениях и наказаниях", title_en:"Administrative Violations and Sanctions Act", type:"zakon", area:["admin"], year:1969, url:"https://lex.bg/bg/laws/ldoc/search?q=ЗАНН" },
  { id:64, title_bg:"Закон за обществените поръчки", title_ru:"Закон о государственных закупках", title_en:"Public Procurement Act", type:"zakon", area:["admin","business"], year:2016, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+обществените+поръчки" },
  // ─── ТРУД ──────────────────────────────────────────────────────────────────
  { id:70, title_bg:"Закон за здравословни и безопасни условия на труд", title_ru:"Закон об охране труда", title_en:"Health and Safety at Work Act", type:"zakon", area:["labor"], year:1997, url:"https://lex.bg/bg/laws/ldoc/search?q=ЗБУТ" },
  { id:71, title_bg:"Закон за насърчаване на заетостта", title_ru:"Закон о содействии занятости", title_en:"Employment Promotion Act", type:"zakon", area:["labor"], year:2001, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+насърчаване+на+заетостта" },
  { id:72, title_bg:"Закон за закрила при безработица и насърчаване на заетостта", title_ru:"Закон о защите при безработице", title_en:"Unemployment Protection Act", type:"zakon", area:["labor"], year:2001, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+закрила+при+безработица" },
  // ─── ГРАЖДАНСКО ────────────────────────────────────────────────────────────
  { id:80, title_bg:"Закон за защита на потребителите", title_ru:"Закон о защите потребителей", title_en:"Consumer Protection Act", type:"zakon", area:["civil","business"], year:2005, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+защита+на+потребителите" },
  { id:81, title_bg:"Закон за защита на личните данни", title_ru:"Закон о защите персональных данных", title_en:"Personal Data Protection Act", type:"zakon", area:["civil","admin"], year:2002, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+защита+на+личните+данни" },
  { id:82, title_bg:"Закон за задълженията и договорите — допълнения", title_ru:"ЗЗД — поправки", title_en:"OCA — amendments", type:"zakon", area:["civil"], year:1950, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+задълженията+и+договорите+—+допълнения" },
  { id:83, title_bg:"Закон за лицата и семейството", title_ru:"Закон о лицах и семье", title_en:"Persons and Family Act", type:"zakon", area:["civil"], year:1949, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+лицата+и+семейството" },
  { id:84, title_bg:"Закон за медиацията", title_ru:"Закон о медиации", title_en:"Mediation Act", type:"zakon", area:["civil"], year:2004, url:"https://lex.bg/bg/laws/ldoc/search?q=Закон+за+медиацията" },
  // ─── НАРЕДБИ ───────────────────────────────────────────────────────────────
  { id:90, title_bg:"Наредба за регистрация на чужденците", title_ru:"Положение о регистрации иностранцев", title_en:"Regulation on Registration of Foreigners", type:"naredba", area:["migration"], year:2011, url:"https://lex.bg/bg/laws/ldoc/search?q=Наредба+за+регистрация+на+чужденците" },
  { id:91, title_bg:"Наредба № Н-18 за регистриране на продажби чрез фискални устройства", title_ru:"Наредба № Н-18 о регистрации продаж", title_en:"Regulation N-18 on Sales Registration", type:"naredba", area:["tax","business"], year:2006, url:"https://lex.bg/bg/laws/ldoc/search?q=Наредба+№+Н-18+за+регистриране+на+продажби+чрез+фискални+устройства" },
  { id:92, title_bg:"Тарифа № 4 за таксите в системата на МВР", title_ru:"Тариф № 4 — пошлины МВР", title_en:"Tariff No. 4 — MVR Fees", type:"naredba", area:["migration","admin"], year:2012, url:"https://lex.bg/bg/laws/ldoc/search?q=Тарифа+№+4+за+таксите+в+системата+на+МВР" },
  { id:93, title_bg:"Наредба за командировките в страната", title_ru:"Положение о командировках", title_en:"Regulation on Business Travel", type:"naredba", area:["labor","tax"], year:1987, url:"https://lex.bg/bg/laws/ldoc/search?q=Наредба+за+командировките+в+страната" },
];
